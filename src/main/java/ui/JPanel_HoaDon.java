...
public class JPanel_HoaDon extends JPanel {
	...
	public JPanel_HoaDon() {
		...
		pnl.setBorder(new TitledBorder(
				...
				"Ho\u0301a \u0110\u01A1n", TitledBorder.LEADING, TitledBorder.TOP, null, new Color(0, 85, 170)));
		add(pnl);
		pnl.setLayout(null);
		...
		panel_1.setBorder(
				new TitledBorder(new EtchedBorder(EtchedBorder.LOWERED, new Color(0, 85, 170), new Color(0, 85, 170)),
						"Danh sa\u0301ch ho\u0301a \u0111\u01A1n", TitledBorder.LEADING, TitledBorder.TOP, null,
						new Color(0, 85, 170)));
		...
		panel_1_1.setBorder(
				new TitledBorder(new EtchedBorder(EtchedBorder.LOWERED, new Color(0, 85, 170), new Color(0, 85, 170)),
						"Chi ti\u1EBFt h\u00F3a \u0111\u01A1n", TitledBorder.LEADING, TitledBorder.TOP, null,
						new Color(0, 85, 170)));
...
//////
					...
					for (HoaDon hd : list) {
						...
						Object[] obj = new Object[] { hd.getMaHoaDon(), hd.getKhachHang().getMaKhachHang(),
...
////
			...
			for (HoaDon hoadon : listHoaDon) {
				...
				String tongTien1 = df.format(tongTien);
				Object[] obj = new Object[] { hoadon.getMaHoaDon(), hoadon.getKhachHang().getMaKhachHang(),
